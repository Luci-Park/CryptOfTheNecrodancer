...
namespace cl
{
	...
	void RedDragonSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mAnimations[1][1], L"RedDragon", path, 18, 2, 12, 0, 3, Vector2(-30, -51), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mAnimations[0][1], L"RedDragon", path, 18, 2, 15, 0, 4, Vector2(-30, -51), BeatManager::BeatDuration());
		...
		mAnimator->CreateAnimation(mShadowAnimations[1][1], L"RedDragon", path, 18, 2, 12, 1, 3, Vector2(-30, -51), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mShadowAnimations[0][1], L"RedDragon", path, 18, 2, 15, 1, 4, Vector2(-30, -51), BeatManager::BeatDuration());
	}
