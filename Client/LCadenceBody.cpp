...
namespace cl
{
	...
	void CadenceBody::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, L"CadenceLeft", leftPath, 16, 16, 12, 2, 4, -Vector2(12, 24), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mRightAnimation, L"CadenceRight", rightPath, 16, 16,0, 2, 4, -Vector2(12, 24), BeatManager::BeatDuration());
