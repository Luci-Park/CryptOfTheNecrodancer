...
namespace cl
{
	...
	void RedBatSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, mLeftAnimation, leftPath, 4, 8, 0, 2, 4, -Vector2(12, 24), Conductor::Instance().SecondsPerBeat());
		mAnimator->CreateAnimation(mRightAnimation, mRightAnimation, rightPath, 4, 8, 0, 2, 4, -Vector2(12, 24), Conductor::Instance().SecondsPerBeat());
