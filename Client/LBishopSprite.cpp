...
namespace cl
{
	...
	void BishopSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mReady, L"Bishop_Ready", path, 1, 2, 0, 0, 1, -Vector2(17 *0.5, 32), BeatManager::BeatDuration() * 2);
		mAnimator->CreateAnimation(mShadowReady, L"Bishop_Ready", path, 1, 2, 0, 1, 1, -Vector2(17 *0.5, 32), BeatManager::BeatDuration() * 2);
		Idle();
	}
