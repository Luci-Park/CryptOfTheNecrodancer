...
namespace cl
{
	...
	void RedBatSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, mLeftAnimation, leftPath, 4, 8, 0, 2, 4, Vector2::Zero, 0.36f);
		mAnimator->CreateAnimation(mRightAnimation, mRightAnimation, rightPath, 4, 8, 0, 2, 4, Vector2::Zero, 0.36f);
		mAnimator->CreateAnimation(mLeftShadowAnimation, mLeftAnimation, leftPath, 4, 8, 0, 1, 4, Vector2::Zero, 0.36f);
		mAnimator->CreateAnimation(mRightShadowAnimation, mRightAnimation, rightPath, 4, 8, 0, 1, 4, Vector2::Zero, 0.36f);
		Turn(Vector2::Right);
	}
