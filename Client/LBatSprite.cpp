...
namespace cl
{
	...
	void BatSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, mLeftAnimation, leftPath, 4, 8, 0, 0, 4, Vector2::Zero, 0.36f);
		mAnimator->CreateAnimation(mRightAnimation, mRightAnimation, rightPath, 4, 8, 0, 0, 4, Vector2::Zero, 0.36f);
