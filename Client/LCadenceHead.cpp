...
namespace cl
{
	...
	void CadenceHead::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, L"CadenceLeft", leftPath, 16, 16, 12, 0, 4, -Vector2(12, 24), 0.36f);
		mAnimator->CreateAnimation(mRightAnimation, L"CadenceRight", rightPath, 16, 16, 0, 0, 4, -Vector2(12, 24), 0.36f);
