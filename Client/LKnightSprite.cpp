...
namespace cl
{
	...
	void KnightSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mShadowIdle, L"Knight", path, 4, 2, 0, 1, 4, -Vector2(92 * 0.25 * 0.5, 56 * 0.5f), BeatManager::BeatDuration());
		...
		mAnimator->CreateAnimation(mShadowReady, L"Knight_Ready", path, 1, 2, 0, 1, 1, -Vector2(9, 56 * 0.5), BeatManager::BeatDuration());
		Idle();
	}
}