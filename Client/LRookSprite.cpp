...
namespace cl
{
	...
	void RookSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mShadowIdle, L"Rook", path, 2, 2, 0, 1, 2, -Vector2(38 * 0.25, 52 * 0.5f), BeatManager::BeatDuration());
		...
		mAnimator->CreateAnimation(mShadowReady, L"Rook_Ready", path, 1, 2, 0, 1, 1, -Vector2(9, 52 * 0.5), BeatManager::BeatDuration());
		Idle();
	}
