...
namespace cl
{
	...
	void GreenDragonSprite::Initialize()
	{
		...
		mAnimator->CreateAnimation(mLeftAnimation, L"GreenDragon", path, 8, 2, 0, 0, 4, -Vector2(27, 51), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mRightAnimation, L"GreenDragon", path, 8, 2, 4, 0, 4, -Vector2(27, 51), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mLeftShadowAnimation, L"GreenDragon", path, 8, 2, 0, 1, 4, -Vector2(27, 51), BeatManager::BeatDuration());
		mAnimator->CreateAnimation(mRightShadowAnimation, L"GreenDragon", path, 8, 2, 4, 1, 4, -Vector2(27, 51), BeatManager::BeatDuration());
		Turn(Vector2::Right);
	}
